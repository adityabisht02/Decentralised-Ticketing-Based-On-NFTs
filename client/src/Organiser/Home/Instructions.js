...
function Instructions() {
  return (
    <div className="relative flex flex-col justify-center overflow-hidden bg-gray-50 py-3 px-3 sm:py-12 ">
      <div className="relative bg-white px-3 pt-3 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
        <div className="mx-auto ">
          <div className="divide-y divide-gray-300/50">
            <div className="space-y-6 py-8 text-base leading-7 text-gray-600">
              <p className="text-center font-bold ">WHY NFT TICKETS?</p>
